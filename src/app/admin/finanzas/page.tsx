...
export default function FinanzasPage() {
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      ...
      <p className="text-xs text-slate-400 -mt-2">Ventas − Costo (compras) = Ganancia. Todos los montos incluyen IGV (venta y costo en la misma base, para que la ganancia sea real).</p>
